        ...
        <div class="sku-box store-content">
            <div class="sort-option">
                <ul class="line clear"
                    ...
                    <li><a 
                        href="javascript:;" 
                        :class="{'active':chooseNum==='综合排序'}"
                        >综合排序</a></li>
                    <li><a href="javascript:;" 
                        :class="{'active':chooseNum==='销量排序'}"
                        >销量排序</a></li>
                    <li>
                        <a href="javascript:;" 
                        :class="{'active':chooseNum==='价格低到高'}"
                        @click="lowToUpFn"
                        >价格低到高</a></li>
                    <li>
                        <a href="javascript:;" 
                        :class="{'active':chooseNum==='价格高到低'}"
                        @click="upToLowFn"
                        >价格高到低</a></li>
                </ul>
            </div>
...
import list from '@/assets/dataJS/newGoodsData.js'
...
export default {
    ...
    methods:{
        ...
        everyoneFn(e){// 采用事件代理来添加class 
            this.chooseNum = e.target.innerHTML;
        }
    }
}
</script>
