        ...
        <div class="nav-global">
            <div class="container">
                ...
                <ul class="nav-aside">
                    ...
                    <li 
                      class="nav-cart"
                      @mouseover = "$store.commit('showFn')"
                      @mouseleave = "$store.commit('hideFn')"
                      >
                        <a href="javascript:;">购物车</a>
                        <!--根据class改变颜色-->
                        <span 
                          class="cart-empty-num"
                          :class="{'cart-num': !!$store.getters.totalNum }">
                            <i>{{$store.getters.totalNum}}</i>
                        </span>
                        <shop-cart></shop-cart>
...
<script>
import s from "@/components/shop-cart.vue"
export default {
  components:{ 
    "shop-cart": s
  }
